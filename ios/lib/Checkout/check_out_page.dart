...
import 'package:bylaive/Screens/add_address_page.dart';
import 'package:bylaive/Checkout/unpaid_page.dart';
import 'package:flutter/material.dart';

import 'package:bylaive/Checkout/credit_card.dart';
import 'package:bylaive/Checkout/shop_item_list.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('https://5.imimg.com/data5/WI/EB/MY-45054986/boys-designer-shirts-500x500.jpg',
        'Boat roackerz 400 On-Ear Bluetooth Headphones', 'description', 45.3),
    Product('https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/bd05e730664785.562df53513b90.jpg',
        'Boat roackerz 100 On-Ear Bluetooth Headphones', 'description', 22.3),
    Product('https://www.iconbunny.com/icons/media/catalog/product/1/0/1070.4-shopping-bags-icon-iconbunny.jpg',
